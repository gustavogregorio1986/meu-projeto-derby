...
exports.mixin = {};
Model_1.Model.prototype._splitPath = function (subpath) {
 ...
 * @api public
 */
Model_1.Model.prototype.path = function (subpath) {
    if (subpath == null || subpath === '')
        return (this._at) ? this._at : '';
    if (typeof subpath === 'string' || typeof subpath === 'number') {
        return (this._at) ? this._at + '.' + subpath : '' + subpath;
    }
    if (typeof subpath.path === 'function')
        return subpath.path();
};
Model_1.Model.prototype.isPath = function (subpath) {
    return this.path(subpath) != null;
};
Model_1.Model.prototype.scope = function (path) {
 ...
 *  @api public
 */
Model_1.Model.prototype.at = function (subpath) {
    if (arguments.length > 1) {
        for (var i = 1; i < arguments.length; i++) {
 ...
 * @return {Model} a scoped model
 */
Model_1.Model.prototype.parent = function (levels) {
    if (levels == null)
        levels = 1;
 ...
 * @return {String}
 */
Model_1.Model.prototype.leaf = function (path) {
    if (!path)
        path = this.path();
