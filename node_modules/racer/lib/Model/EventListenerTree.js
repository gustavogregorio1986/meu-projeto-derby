...
exports.EventListenerTree = void 0;
var FastMap_1 = require("./FastMap");
/**
 ...
 */
var EventListenerTree = /** @class */ (function () {
    ...
    EventListenerTree.prototype._getOrCreateChild = function (segments) {
        ...
        for (var i = 0, len = segments.length; i < len; i++) {
            var children = node.children;
            if (!children) {
                children = node.children = new FastMap_1.FastMap();
            }
            var segment = segments[i];
...
exports.EventListenerTree = EventListenerTree;
/**
