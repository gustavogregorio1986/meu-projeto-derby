...
var CollectionMap_1 = require("./CollectionMap");
...
Model_1.Model.prototype.query = function (collectionName, expression, options) {
 ...
 */
Model_1.Model.prototype._getOrCreateQuery = function (collectionName, expression, options, QueryConstructor) {
...
// stack error
Model_1.Model.prototype.sanitizeQuery = function (expression) {
...
Model_1.Model.prototype._initQueries = function (items) {
    for (var i = 0; i < items.length; i++) {
        var _a = items[i], countsList = _a[0], collectionName = _a[1], expression = _a[2], _results = _a[3], options = _a[4], extra = _a[5];
        ...
        // const extra = item[5];
        var _b = countsList[0], _subscribed = _b[0], _fetched = _b[1], contextId = _b[2];
        var subscribed = _subscribed || 0;
        var fetched = _fetched || 0;
...
var Queries = /** @class */ (function () {
    function Queries() {
        ...
        this.collectionMap = new CollectionMap_1.CollectionMap();
    }
...
var Query = /** @class */ (function () {
    function Query(model, collectionName, expression, options) {
        this.fetchPromised = promisify(Query.prototype.fetch);
        this.subscribePromised = promisify(Query.prototype.subscribe);
        this.unfetchPromised = promisify(Query.prototype.unfetch);
        this.unsubscribePromised = promisify(Query.prototype.unsubscribe);
    ...
    Query.prototype._subscribeCb = function (cb) {
        ...
        return function subscribeCb(err, results, extra) {
            if (err)
                return query._flushSubscribeCallbacks(err, cb);
            query._setExtra(extra);
            query._setResults(results);
    ...
    Query.prototype._diffMapIds = function (ids) {
        ...
        for (var id_1 in this.idMap) {
            if (newMap[id_1])
                continue;
            removedIds.push(id_1);
        }
        if (addedIds.length)
            this._addMapIds(addedIds);
        if (removedIds.length)
            this._removeMapIds(removedIds);
    };
    ;
