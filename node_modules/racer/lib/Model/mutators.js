...
Model_1.Model.prototype._mutate = function (segments, fn, cb) {
...
Model_1.Model.prototype.set = function () {
...
Model_1.Model.prototype.setPromised = promisify(Model_1.Model.prototype.set);
Model_1.Model.prototype._set = function (segments, value, cb) {
...
Model_1.Model.prototype.setNull = function () {
    var subpath, value, cb;
    if (arguments.length === 1) {
        value = arguments[0];
    }
...
Model_1.Model.prototype.setNullPromised = promisify(Model_1.Model.prototype.setNull);
Model_1.Model.prototype._setNull = function (segments, value, cb) {
    segments = this._dereference(segments);
    var model = this;
...
Model_1.Model.prototype.setEach = function () {
...
Model_1.Model.prototype.setEachPromised = promisify(Model_1.Model.prototype.setEach);
Model_1.Model.prototype._setEach = function (segments, object, cb) {
    segments = this._dereference(segments);
...
Model_1.Model.prototype.create = function () {
    var subpath, value, cb;
...
Model_1.Model.prototype.createPromised = promisify(Model_1.Model.prototype.create);
Model_1.Model.prototype._create = function (segments, value, cb) {
    segments = this._dereference(segments);
...
Model_1.Model.prototype.createNull = function () {
    var subpath, value, cb;
    if (arguments.length === 0) {
        value = {};
    }
...
Model_1.Model.prototype.createNullPromised = promisify(Model_1.Model.prototype.createNull);
Model_1.Model.prototype._createNull = function (segments, value, cb) {
    segments = this._dereference(segments);
...
Model_1.Model.prototype.add = function () {
    var subpath, value, cb;
    if (arguments.length === 0) {
        value = {};
    }
...
Model_1.Model.prototype.addPromised = promisify(Model_1.Model.prototype.add);
Model_1.Model.prototype._add = function (segments, value, cb) {
    if (typeof value !== 'object') {
        var message = 'add requires an object value. Invalid value: ' + value;
        var errorCallback = this.wrapCallback(cb);
    ...
    var callbackWithId = (cb != null)
        ? function (err) { cb(err, id); }
        : null;
    this._mutate(segments, add, callbackWithId);
    return id;
};
Model_1.Model.prototype.del = function () {
    var subpath, cb;
    if (arguments.length === 1) {
        if (typeof arguments[0] === 'function') {
            cb = arguments[0];
...
Model_1.Model.prototype.delPromised = promisify(Model_1.Model.prototype.del);
Model_1.Model.prototype._del = function (segments, cb) {
    segments = this._dereference(segments);
    return this._delNoDereference(segments, cb);
};
Model_1.Model.prototype._delNoDereference = function (segments, cb) {
    var model = this;
...
Model_1.Model.prototype.increment = function () {
...
Model_1.Model.prototype.incrementPromised = promisify(Model_1.Model.prototype.increment);
Model_1.Model.prototype._increment = function (segments, byNumber, cb) {
    segments = this._dereference(segments);
    if (byNumber == null)
        byNumber = 1;
    var model = this;
...
Model_1.Model.prototype.push = function () {
    var subpath, value, cb;
    if (arguments.length === 1) {
        value = arguments[0];
    }
...
Model_1.Model.prototype.pushPromised = promisify(Model_1.Model.prototype.push);
Model_1.Model.prototype._push = function (segments, value, cb) {
...
Model_1.Model.prototype.unshift = function () {
    var subpath, value, cb;
    if (arguments.length === 1) {
        value = arguments[0];
    }
...
Model_1.Model.prototype.unshiftPromised = promisify(Model_1.Model.prototype.unshift);
Model_1.Model.prototype._unshift = function (segments, value, cb) {
    var forArrayMutator = true;
    segments = this._dereference(segments, forArrayMutator);
    var model = this;
...
Model_1.Model.prototype.insert = function () {
...
Model_1.Model.prototype.insertPromised = promisify(Model_1.Model.prototype.insert);
Model_1.Model.prototype._insert = function (segments, index, values, cb) {
    var forArrayMutator = true;
    segments = this._dereference(segments, forArrayMutator);
    var model = this;
...
Model_1.Model.prototype.pop = function () {
    var subpath, cb;
    if (arguments.length === 1) {
        if (typeof arguments[0] === 'function') {
            cb = arguments[0];
...
Model_1.Model.prototype.popPromised = promisify(Model_1.Model.prototype.pop);
Model_1.Model.prototype._pop = function (segments, cb) {
    var forArrayMutator = true;
    segments = this._dereference(segments, forArrayMutator);
    var model = this;
...
Model_1.Model.prototype.shift = function () {
    var subpath, cb;
    if (arguments.length === 1) {
        if (typeof arguments[0] === 'function') {
            cb = arguments[0];
...
Model_1.Model.prototype.shiftPromised = promisify(Model_1.Model.prototype.shift);
Model_1.Model.prototype._shift = function (segments, cb) {
    var forArrayMutator = true;
    segments = this._dereference(segments, forArrayMutator);
    var model = this;
...
Model_1.Model.prototype.remove = function () {
...
Model_1.Model.prototype.removePromised = promisify(Model_1.Model.prototype.remove);
Model_1.Model.prototype._remove = function (segments, index, howMany, cb) {
    var forArrayMutator = true;
    segments = this._dereference(segments, forArrayMutator);
    if (howMany == null)
        howMany = 1;
...
Model_1.Model.prototype.move = function () {
...
Model_1.Model.prototype.movePromised = promisify(Model_1.Model.prototype.move);
Model_1.Model.prototype._move = function (segments, from, to, howMany, cb) {
    var forArrayMutator = true;
    segments = this._dereference(segments, forArrayMutator);
    if (howMany == null)
        howMany = 1;
...
Model_1.Model.prototype.stringInsert = function () {
...
Model_1.Model.prototype.stringInsertPromised = promisify(Model_1.Model.prototype.stringInsert);
Model_1.Model.prototype._stringInsert = function (segments, index, text, cb) {
    segments = this._dereference(segments);
    var model = this;
...
Model_1.Model.prototype.stringRemove = function () {
    var subpath, index, howMany, cb;
    if (arguments.length < 2) {
...
Model_1.Model.prototype.stringRemovePromised = promisify(Model_1.Model.prototype.stringRemove);
Model_1.Model.prototype._stringRemove = function (segments, index, howMany, cb) {
    segments = this._dereference(segments);
    var model = this;
...
Model_1.Model.prototype.subtypeSubmit = function () {
...
Model_1.Model.prototype.subtypeSubmitPromised = promisify(Model_1.Model.prototype.subtypeSubmit);
Model_1.Model.prototype._subtypeSubmit = function (segments, subtype, subtypeOp, cb) {
    segments = this._dereference(segments);
    var model = this;
