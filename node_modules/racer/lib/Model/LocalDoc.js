...
exports.LocalDoc = void 0;
var Doc_1 = require("./Doc");
var util = require('../util');
var LocalDoc = /** @class */ (function (_super) {
    __extends(LocalDoc, _super);
    function LocalDoc(model, collectionName, id, data) {
        var _this = _super.call(this, model, collectionName, id, data) || this;
        _this._updateCollectionData();
        return _this;
    }
