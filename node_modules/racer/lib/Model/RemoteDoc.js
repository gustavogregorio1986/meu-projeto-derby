...
var RemoteDoc = /** @class */ (function (_super) {
    __extends(RemoteDoc, _super);
    function RemoteDoc(model, collectionName, id, snapshot, collection) {
        var _this = _super.call(this, model, collectionName, id) || this;
        ...
        // creating a new one
        if (collection)
            collection.docs[id] = _this;
        _this.model = model.pass({ $remote: true });
        _this.debugMutations = model.root.debug.remoteMutations;
        ...
        _this.shareDoc = model.root.connection.get(collectionName, id);
        _this.shareDoc.ingestSnapshot(snapshot);
        _this._initShareDoc();
        return _this;
    }
    ...
    RemoteDoc.prototype._onOp = function (op) {
        ...
        if (defined(item.oi) || defined(item.od)) {
            ...
            var index = segments[segments.length - 1];
            var text = item.sd;
            var howMany_1 = text.length;
            segments = segments.slice(0, -1);
            var value = model._get(segments);
            var previous = value.slice(0, index) + text + value.slice(index);
            var pass = model.pass({ $stringRemove: { index: index, howMany: howMany_1 } })._pass;
            var event = new ChangeEvent(value, previous, pass);
            model._emitMutation(segments, event);
            // IncrementOp
        }
            ...
            var previous_1 = value - item.na;
            var event = new ChangeEvent(value, previous_1, model._pass);
            model._emitMutation(segments, event);
            // SubtypeOp
        }
...
var ListReplaceOp = /** @class */ (function () {
    ...
    return ListReplaceOp;
}());
var ListInsertOp = /** @class */ (function () {
...
var ListRemoveOp = /** @class */ (function () {
...
var StringInsertOp = /** @class */ (function () {
    function StringInsertOp(segments, index, value) {
        this.p = util.castSegments(segments.concat(index));
        this.si = value;
    }
    return StringInsertOp;
}());
var StringRemoveOp = /** @class */ (function () {
    function StringRemoveOp(segments, index, value) {
        this.p = util.castSegments(segments.concat(index));
        this.sd = value;
    }
    return StringRemoveOp;
}());
var IncrementOp = /** @class */ (function () {
