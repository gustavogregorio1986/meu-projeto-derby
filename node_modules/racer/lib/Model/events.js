...
exports.mutationEvents = exports.MoveEvent = exports.RemoveEvent = exports.InsertEvent = exports.UnloadEvent = exports.LoadEvent = exports.ChangeEvent = exports.Passed = void 0;
var events_1 = require("events");
var EventListenerTree_1 = require("./EventListenerTree");
var Model_1 = require("./Model");
var util_1 = require("../util");
Model_1.Model.INITS.push(function (model) {
    var root = model.root;
    events_1.EventEmitter.call(root);
    ...
    var mutationListeners = {
        all: new EventListenerTree_1.EventListenerTree()
    };
    for (var name in exports.mutationEvents) {
        var eventPrototype = exports.mutationEvents[name].prototype;
        mutationListeners[eventPrototype.type] = new EventListenerTree_1.EventListenerTree();
        mutationListeners[eventPrototype._immediateType] = new EventListenerTree_1.EventListenerTree();
    }
...
(0, util_1.mergeInto)(Model_1.Model.prototype, events_1.EventEmitter.prototype);
Model_1.Model.prototype.wrapCallback = function (cb) {
    if (!cb)
        return this.root._defaultCallback;
    var model = this;
...
Model_1.Model.prototype._emitError = function (err, context) {
...
Model_1.Model.prototype._emitMutation = function (segments, event) {
    if (this._silent)
        return;
    var root = this.root;
    ...
    while (root._mutationEventQueue) {
        if (--limit < 0) {
            throw new Error('Maximum model mutation event cycles exceeded. Most likely, an event ' +
...
Model_1.Model.prototype._callMutationListeners = function (type, segments, event) {
...
Model_1.Model.prototype.__on = events_1.EventEmitter.prototype.on;
// @ts-expect-error ignore method overload issues
Model_1.Model.prototype.addListener = Model_1.Model.prototype.on = function (type, arg1, arg2, arg3) {
...
Model_1.Model.prototype.__once = events_1.EventEmitter.prototype.once;
// @ts-expect-error ignore method overload issues
Model_1.Model.prototype.once = function (type, arg1, arg2, arg3) {
    var listener = this._addMutationListener(type, arg1, arg2, arg3);
    if (listener) {
...
Model_1.Model.prototype.__removeListener = events_1.EventEmitter.prototype.removeListener;
Model_1.Model.prototype.removeListener = function (type, listener) {
...
Model_1.Model.prototype.__removeAllListeners = events_1.EventEmitter.prototype.removeAllListeners;
Model_1.Model.prototype.removeAllListeners = function (type, subpath) {
    var segments = this._splitPath(subpath);
    this._removeAllListeners(type, segments);
};
Model_1.Model.prototype._removeAllListeners = function (type, segments) {
...
Model_1.Model.prototype.pass = (Object.assign) ?
    ...
    function (object, invert) {
        ...
        var pass = new Passed();
        if (invert) {
            (0, util_1.mergeInto)(pass, object);
            (0, util_1.mergeInto)(pass, this._pass);
        }
        else {
            (0, util_1.mergeInto)(pass, this._pass);
            (0, util_1.mergeInto)(pass, object);
 ...
 * @return {Model}
 */
Model_1.Model.prototype.silent = function (value) {
    var model = this._child();
    model._silent = (value == null) ? true : !!value;
    return model;
};
Model_1.Model.prototype.eventContext = function (id) {
    var model = this._child();
    model._eventContext = id;
    return model;
};
Model_1.Model.prototype.removeContextListeners = function () {
...
Model_1.Model.prototype._removeMutationListener = function (listener) {
    listener.node.removeOwnListener(listener);
    var id = this._eventContext;
    if (id == null)
        return;
...
Model_1.Model.prototype._addMutationListener = function (type, arg1, arg2, arg3) {
    var tree = this.root._mutationListeners[type];
    if (!tree)
        return;
...
var RemoveEvent = /** @class */ (function () {
...
function normalizePattern(pattern) {
    ...
    return (pattern.charAt(end) === '*' &&
        pattern.charAt(end - 1) === '*' &&
        pattern.charAt(end - 2) !== '.' &&
        pattern.charAt(end - 2)) ? pattern.slice(0, end - 1) + '.**' : pattern;
}
;
